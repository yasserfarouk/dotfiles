...
return {
	...
	-- FZF
	{
		...
		keys = {
			...
			{ "<leader>Sg", "<cmd>FzfLua grep_curbuf<cr>", desc = "fuzzy search buffer" },
			-- { "<leader>;", "<cmd>Telescope file_browser<cr>",  desc = "file browser"  },
			...
			{ "<leader>So", "<cmd>FzfLua vim_options<cr>", desc = "vim_options" },
			...
			{ "<leader>Sc", "<cmd>FzfLua colorschemes<cr>", desc = "colors" },
			{ "<leader>SC", "<cmd>FzfLua commands<cr>", desc = "colors" },
			{ "<leader>Sa", "<cmd>FzfLua files<cr>", desc = "find files" },
			{ "<leader>S*", "<cmd>FzfLua grep_project<cr>", desc = "search current word" },
			{ "<leader>S;", "<cmd>FzfLua filetypes<cr>", desc = "filetypes" },
			{ "<leader>S/", "<cmd>FzfLua command_history<cr>", desc = "history" },
			{ "<leader>Sb", "<cmd>FzfLua buffers<cr>", desc = "pick buffer" },
			{ "<leader>Sd", "<cmd>FzfLua diagnostics_document<cr>", desc = "document diagnostics" },
			{ "<leader>SD", "<cmd>FzfLua diagnostics<cr>", desc = "workspace diagnostics" },
